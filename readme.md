...
Локализация реализована не лучшим образом (сделал всё под русский язык). Хотя я вытянул её в отдельные классы (`DateLocalizationService`, `Constants`), чтобы легче было позже исправить.
<p align="center">
<i>
<b>
To be continued...
