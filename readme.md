...
Потому что приложение состоит из нескольких классов. Лучше добавить позже, с увеличением кодовой базы хотя бы до десятка сервисов.\
...
Со вторника по пятницу (3 дня): 8+ часов - настройка окружения и пр., 5 часов - обучение (т. е., с нуля; можно считать, не входит в задачу), 4.5 часа - код и отладка, 3 часа - UML с описанием.